...
const PropertyForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const propertyData = {
        tenant_id: profile?.tenant_id, // Add required tenant_id
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <FormGroup label="Status">
                        <PropertyStatusMultiSelect
                          ...
                          onChange={(statusArr) => setFormData(prev => ({ ...prev, status: statusArr }))}
                          className="w-full"
                        />
                      </FormGroup>
                ...
                <TabsContent value="location" className="p-6">
                  <div className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <FormGroup label="Location (General)">
                        <Input
                          id="location"
                          name="location"
                      ...
                      <FormGroup label="Distance">
                        <Input
                          ...
                          onChange={handleInputChange}
                          placeholder="Distance from landmarks"
                          className="w-full"
                        />
                      </FormGroup>
                    </div>
                ...
                <TabsContent value="financial" className="p-6">
                  <div className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <FormGroup label="Token NAV">
                        <Input
                          id="token_nav"
                          name="token_nav"
                          type="number"
                          value={formData.token_nav}
                          onChange={handleInputChange}
                          placeholder="0"
                          className="w-full"
                        />
                      ...
                      <FormGroup label="IRO Sale Price">
                        <Input
                          id="iro_sale_price"
                          name="iro_sale_price"
                          type="number"
                          value={formData.iro_sale_price}
                          onChange={handleInputChange}
                          placeholder="0"
                          className="w-full"
                        />
                      ...
                      <FormGroup label="IRO Participants">
                        <Input
                          id="iro_participants"
                          name="iro_participants"
                          type="number"
                          value={formData.iro_participants}
                          onChange={handleInputChange}
                          placeholder="0"
                          className="w-full"
                        />
